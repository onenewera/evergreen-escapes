...
/**
 * Google account settings template for subsite.
 *
		...
		<div data-panes>
			...
			<div class="sui-tab-boxed">
				...
				<div class="sui-form-field">
					...
					<input type="text" id="google-client-id" name="google[client_id]" placeholder="<?php esc_html_e( 'Place Google Client ID here', 'ga_trans' ); ?>" class="sui-form-control" value="<?php echo esc_html( beehive_analytics()->settings->get( 'client_id', 'google' ) ); ?>">
					<span class="sui-error-message"></span>
				</div>

				<div class="sui-form-field">
					<label for="google-client-secret" class="sui-label"><?php esc_html_e( 'Google Client Secret', 'ga_trans' ); ?></label>
					<input type="text" id="google-client-secret" name="google[client_secret]" placeholder="<?php esc_html_e( 'Place Google Client Secret here', 'ga_trans' ); ?>" class="sui-form-control" value="<?php echo esc_html( beehive_analytics()->settings->get( 'client_secret', 'google' ) ); ?>">
					<span class="sui-error-message"></span>
				</div>
