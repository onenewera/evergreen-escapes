...
<div class="sui-box">
	...
	<div class="sui-box-banner" role="banner" aria-hidden="true">
		<img src="<?php echo esc_url( Template::asset_url( 'images/onboarding/welcome.png' ) ); ?>" srcset="<?php echo esc_url( Template::asset_url( 'images/onboarding/welcome.png' ) ); ?> 1x, <?php echo esc_url( Template::asset_url( 'images/onboarding/welcome@2x.png' ) ); ?> 2x">
	</div>
		...
		<div class="sui-side-tabs sui-tabs">
			...
			<div data-panes>
				...
				<div class="sui-tab-boxed beehive-google-setup-connect active">
					...
					<div class="sui-form-field">
						<label for="google-modal-access-code" class="sui-label"><?php _e( 'Access Code', 'ga_trans' ); ?></label>
