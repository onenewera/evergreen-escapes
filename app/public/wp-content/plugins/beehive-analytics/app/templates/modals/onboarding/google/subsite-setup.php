...
/**
 * Google account settings template for subsite modal.
 *
 * @var string $login_url         Google login url.
 * @var bool   $network_logged_in Is network API setup? (Only in subsite).
 * @var bool   $networkwide       Is plugin active network wide?.
 * @var bool   $network_setup     Is API creds setup in network admin?.
 */
...
<div class="sui-box sui-block-content-center">
	...
	<div class="sui-box-header sui-lg">
	...
	<div class="sui-box-body sui-lg">
		...
		<?php if ( $networkwide && $network_logged_in && $network_setup ) : ?>

			<div class="beehive-google-setup-connect">

				<div class="sui-form-field google-setup-connect">
					<a href="<?php echo esc_url( $login_url ); ?>" class="sui-button beehive-connect-google-btn">
						<i class="sui-icon-google-connect" aria-hidden="true"></i>
						<?php esc_html_e( 'Connect with Google', 'ga_trans' ); ?>
					</a>
					<span class="sui-description">
						<?php esc_html_e( 'Why to connect wth Google?', 'ga_trans' ); ?>
						<span class="beehive-icon-tooltip sui-tooltip sui-tooltip-right sui-tooltip-constrained" data-tooltip="<?php esc_html_e( 'We need to authenticate your account with Google to ensure you actually own the analytics data. We only retrieve analytics information and no personally identifiable data.', 'ga_trans' ); ?>">
			...
			<div class="sui-side-tabs sui-tabs">
				...
				<div data-panes>
					...
					<div class="sui-tab-boxed beehive-google-setup-connect active">
						...
						<div class="sui-form-field google-setup-connect">
							<a href="<?php echo esc_url( $login_url ); ?>" target="_blank" class="sui-button beehive-connect-google-btn">
								<i class="sui-icon-google-connect" aria-hidden="true"></i>
								<?php esc_html_e( 'Connect with Google', 'ga_trans' ); ?>
							</a>
							<span class="sui-description">
					...
					<div class="sui-tab-boxed">
						...
						<div class="sui-form-field">
							...
							<input type="text" id="google-modal-client-id" placeholder="<?php esc_html_e( 'Place Google Client ID here', 'ga_trans' ); ?>" class="sui-form-control" value="<?php echo beehive_analytics()->settings->get( 'client_id', 'google' ); ?>">
							<span class="sui-error-message"></span>
						</div>

						<div class="sui-form-field">
							<label for="google-modal-client-secret" class="sui-label"><?php esc_html_e( 'Google Client Secret', 'ga_trans' ); ?></label>
							<input type="text" id="google-modal-client-secret" placeholder="<?php esc_html_e( 'Place Google Client Secret here', 'ga_trans' ); ?>" class="sui-form-control" value="<?php echo beehive_analytics()->settings->get( 'client_secret', 'google' ); ?>">
							<span class="sui-error-message"></span>
						</div>
